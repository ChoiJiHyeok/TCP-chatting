...
class ChatClient(QWidget, form_class):
    ...
    def add_chat_room(self):
        ...
        open_chat_message = (f"{self.sender_name}/!@|CHATING ROOM OPEN|@!/chat_room_{chat_name}").encode()
    ...
    def initialize_socket(self, ip, port):
        ...
        connect_message= (f"{self.sender_name}/{self.sender_name}님이 접속했습니다.").encode()
